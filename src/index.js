  ...
  return (
    <footer className="footer">
      {isOpen ? (
        ...
        <p>Sorry we are currently closed.Come back tomorrow @ {openHour}:00</p>
      )}
    </footer>
  );
}
...
function Order(props) {
  return (
    <div className="order">
      <p>
        We're open untill {props.closeHour}:00. Come vist us or order online
      </p>
...
function Pizza({pizzaObj}) {
  return (
    <li className="pizza">
      ...
      <p>
        Price<span>{pizzaObj.price}</span>
      </p>
    </li>
  );
}
